...
Copyright (c) {revyear} Eclipse Foundation.
...
* All existing copyright notices, or if one does not exist, a notice
  ...
  of the form: "Copyright (c) {revyear} Eclipse Foundation, Inc.
  https://www.eclipse.org/legal/efsl.php[https://www.eclipse.org/legal/efsl.php]"
...
"Copyright (c) {revyear} Eclipse Foundation. This software or document
